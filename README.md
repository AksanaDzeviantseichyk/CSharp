...
For example, for a triangle À(0,0), Â(0,4), Ñ(0,4) sides length will be 4, 5,656854249492381, 4. It is the right triangle, because ÀÂ2 + ÀÑ2 = ÂÑ2. But 42 + 42 != 5,6568542494923812 (due to a precision of double variable type). To solve this problem, you can say that the triangle is right if ÂÑ2 – (ÀÂ2 + ÀÑ2) <= delta, where delta – you own precision.
